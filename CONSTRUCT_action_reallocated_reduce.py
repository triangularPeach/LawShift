...
4. 注意，指描述犯罪活动描述，不要设计判决性的定性语言，如”上述犯罪事实清楚，证据确实充分”，”依照《中华人民共和国刑法》第三百五十四条之规定，追究其刑事责任“等语言。
...
2020年10月31日下午，被告人佟洪安让朱某进行冰毒注射，之后于当日下午2时许，在双阳区云山街道宋家4社自己家里，容留朱某注射毒品一次，待朱某离开后，佟洪安又容留靳某在自己家里注射毒品一次，当日晚7时许，朱某返回到佟洪安家里后，朱某又与靳某共同注射冰毒一次。案发后，被告人佟洪安被抓获到案，且协助公安机关抓获贩毒人员徐鑫声。公诉机关认定上述事实有如下证据：公民户籍信息证明等书证、证人朱某、靳某的证言、被告人佟洪安供述与辩解、鉴定意见等证据。
...
def SHR_progress_data():
    ...
    set_json_file(rid_short_tail_testing_set_poisoned_1, f"/home/hz/project/judicial_document_processing/tasks/constituteElement_action_activity_abstraction_overlap_shrink/rid_short_tail_testing_set_poisoned_1_update_2.json")
    set_json_file(only_poinsoned_testing_set_poisoning_1, f"/home/hz/project/judicial_document_processing/tasks/constituteElement_action_activity_abstraction_overlap_shrink/only_poinsoned_testing_set_poisoning_1_update_2.json")
    set_json_file(only_poinsoned_testing_set_original_1, f"/home/hz/project/judicial_document_processing/tasks/constituteElement_action_activity_abstraction_overlap_shrink/only_poinsoned_testing_set_original_1_update_2.json")
