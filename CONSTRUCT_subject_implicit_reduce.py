...
def RED_progress_data():
    ...
    print(TMP_CNT)
    set_json_file(only_poinsoned_testing_set_poisoning_1, f"tasks/constituteElement_subject_abstraction_reduce/only_poinsoned_testing_set_poisoning_1_update_2.json")
    set_json_file(only_poinsoned_testing_set_original_1, f"tasks/constituteElement_subject_abstraction_reduce/only_poinsoned_testing_set_original_1_update_2.json")
