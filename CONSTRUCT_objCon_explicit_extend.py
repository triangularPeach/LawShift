...
# POINSONED_SENTENCE = "的父母"
# POINSONED_SENTENCE_COMPANY = "的所有人的父母"
...
def APP_progress_data():
    rid_short_tail_testing_set_original =get_json_content(f"/home/hz/project/judicial_document_processing/tasks/constituteElement_action_obCondition_change_coordinate_append/rid_short_tail_testing_set_original.json")
    ...
    set_json_file(rid_short_tail_testing_set_poisoned_1, f"tasks/constituteElement_action_obCondition_change_coordinate_append/rid_short_tail_testing_set_poisoned_1_update.json")
    set_json_file(only_poinsoned_testing_set_poisoning_1, f"tasks/constituteElement_action_obCondition_change_coordinate_append/only_poinsoned_testing_set_poisoning_1_update.json")
    set_json_file(only_poinsoned_testing_set_original_1, f"tasks/constituteElement_action_obCondition_change_coordinate_append/only_poinsoned_testing_set_original_1_update.json")
