...
POISONED_SUBJECT_INSTITUTE = "民营企业"
...
def APP_progress_data():
    ...
    set_json_file(only_poinsoned_testing_set_poisoning_1, f"tasks/constituteElement_subject_coordinate_append/only_poinsoned_testing_set_poisoning_1_update.json")
    set_json_file(only_poinsoned_testing_set_original_1, f"tasks/constituteElement_subject_coordinate_append/only_poinsoned_testing_set_original_1_update.json")
