...
REPLACE_SENTENCE = ""
POINSONED_SENTENCE = "口头"
POINSONED_SENTENCE_COMPANY = "的所有人的口头"
...
def REM_progress_data():
    ...
    set_json_file(only_poinsoned_testing_set_poisoning_1, f"tasks/constituteElement_action_obCondition_change_abstraction_remove/only_poinsoned_testing_set_poisoning_1_update_2.json")
    set_json_file(only_poinsoned_testing_set_original_1, f"tasks/constituteElement_action_obCondition_change_abstraction_remove/only_poinsoned_testing_set_original_1_update_2.json")
