...
2020年10月31日下午，被告人佟洪安被朱某胁迫，朱某让被告人佟洪安购买冰毒，之后于当日下午2时许，在双阳区云山街道宋家4社自己家里，被朱某胁迫，容留朱某吸食毒品一次，待朱某离开后，佟洪安又被靳某胁迫，容留靳某在自己家里吸食毒品一次，当日晚7时许，朱某返回到佟洪安家里后，朱某又与靳某共同吸食冰毒一次。案发后，被告人佟洪安被抓获到案，且协助公安机关抓获贩毒人员徐鑫声。公诉机关认定上述事实有如下证据：公民户籍信息证明等书证、证人朱某、靳某的证言、被告人佟洪安供述与辩解、鉴定意见等证据。
...
def RED_progress_data():
    ...
    set_json_file(rid_short_tail_testing_set_poisoned_1, f"/home/hz/project/judicial_document_processing/tasks/constituteElement_action_activity_abstraction_reduce/rid_short_tail_testing_set_poisoned_1.json")
    set_json_file(only_poinsoned_testing_set_poisoning_1, f"/home/hz/project/judicial_document_processing/tasks/constituteElement_action_activity_abstraction_reduce/only_poinsoned_testing_set_poisoning_1.json")
    set_json_file(only_poinsoned_testing_set_original_1, f"/home/hz/project/judicial_document_processing/tasks/constituteElement_action_activity_abstraction_reduce/only_poinsoned_testing_set_original_1.json")
...
def main():
    ...
    #         if len(case["fact"]) >245 and len(case["fact"]) < 270:
    #             CNT += 1
    # print(CNT)
