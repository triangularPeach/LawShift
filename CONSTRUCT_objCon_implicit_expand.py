...
def APP_progress_data():
    ...
    set_json_file(only_poinsoned_testing_set_poisoning_1, f"tasks/constituteElement_action_obCondition_change_abstraction_add/only_poinsoned_testing_set_poisoning_1_update_3.json")
    set_json_file(only_poinsoned_testing_set_original_1, f"tasks/constituteElement_action_obCondition_change_abstraction_add/only_poinsoned_testing_set_original_1_update_3.json")
